...
export class AccountSummaryComponentComponent implements OnInit {
  ...
  thirdDisplayedColumns: string[] = [
    "currency",
    "allBankAccount",
    "allDepositAccount",
    "allDematAccount",
    "allLoanAccount",
    "allCreditCardAccount"
  ];
  thirdDataSource;
  ...
  accounts: any[] = [{ value: "Bank Account", viewValue: "Bank Account" }];
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(
      params => (this.creditDebitRequestDTO.customerId = params["customerId"])
    );
      ...
      customer => {
        ...
        this.acctDetails.forEach(acctDetails => {
          let model = {
            ...
            branchAddress:
              acctDetails.branchName +
              "," +
              acctDetails.branchCity +
              "," +
              acctDetails.branchState +
              "," +
              acctDetails.branchCountry,
        ...
        const ELEMENT_DATA_THIRD: ThirdTableData[] = [
          {
            currency: "INR",
            allBankAccount: this.totalBankBalance,
            allDepositAccount: "1",
            allDematAccount: "0",
            allLoanAccount: "0",
            allCreditCardAccount: "0"
          }
        ];
